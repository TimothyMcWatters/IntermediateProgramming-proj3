...
public class Talk extends Option {
	
	private String optionName = "";
	private double optionCost = 0.0;
	
	/**
	 * default constructor for the Talk class
	 */
	public Talk() {
		setOptionName("");
		setOptionCost(0.0);
	...
	/**
	 * parameterized constructor for the Talk class
	 * @param optionName = the name of the option
	 * @param optionCost = the cost of the option
	 */
	public Talk(String optionName, double optionCost) {
